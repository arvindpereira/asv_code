...
/*  Note: (Unfortunate)
	This code has been ported to C from C++ by Arvind Pereira,
	due to the inavailability of the appropriate glibc class
	on the MZ-104 at the time of the 1st ROSS test.
*/
